...
cfg.max_shift_limit = 50;      % max total shift in PIXELS, all above this are omitted. Does not currently work with non-ridig registration (disabled by authors).
%cfg.use_phase_correlation = 1; % default is 1, but you can try 0 for classic (standard) correlation

%%% INPUT FILES AND OUTPUT FOLDER

cfg.experiment_ID = '2093_NC_170410';
cfg.sbxfiles{1}='C:\Users\skOpti_6\Documents\MATLAB\klab_Suite2P\TESTDATA\2093_NC_170410_000_007.mat';
cfg.sbxfiles{2}='C:\Users\skOpti_6\Documents\MATLAB\klab_Suite2P\TESTDATA\2093_NC_170410_000_008.mat';
